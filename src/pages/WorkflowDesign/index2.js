                                                                                                                                        ...
                                                                                                                                        li4.steps.map((li5,i5)=>{
                                                                                                                                            return(
                                                                                                                                                <div className='li2' key={ i5 }>
                                                                                                                                                    ...
                                                                                                                                                    {
                                                                                                                                                        li5.enableFlag?
                                                                                                                                                            <Button className='icon_clo' onClick={self._changeEnable.bind(self,{type:0,id:li5.id,i1:index,i2:step_i,i3,i4,i5})} type='primary' >
                                                                                                                                                                关闭使能
                                                                                                                                                            </Button> 
                                                                                                                                                        :
                                                                                                                                                            <Button className='icon_clo' onClick={self._changeEnable.bind(self,{type:1,id:li5.id,i1:index,i2:step_i,i3,i4,i5})} type='primary' >
                                                                                                                                                                使能
                                                                                                                                                            </Button> 
                                                                                                                                                    }
