...
import './index.scss'
import { Row,Col,Input,Form,Icon,Select,Button } from 'antd'
           ...
           <Row>
                <Col span={8} className="row_left">
                    ...
                    <Form.Item
                        ...
                        labelCol={{ span: 12 }} wrapperCol={{ span: 12 }}
                    >
                        {getFieldDecorator('dist', {initialValue:0.1,rules: [{required: true, message: 'Please input your fitDist!' }], })(
                        <Input />
                        )}
                    </Form.Item>
                    ...
                    <Form.Item
                        ...
                        labelCol={{ span: 12 }} wrapperCol={{ span: 12 }}
                    >
                        {getFieldDecorator('speed', {initialValue:1,rules: [{required: true, message: 'Please input your fitDist!' }], })(
                        <Input />
                        )}
                    </Form.Item>
